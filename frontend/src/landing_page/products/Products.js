  ...
  return (
    <>
      ...
      imageURL="media/images/varsity.png"
        ...
        appStore=""
        />
        <p className="text-center p-5" style={{fontSize:"25px"}}>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech</a> blog.</p>
      <Universe />
    </>
  );
}
